...
//        String BASE_URL = "http://192.168.1.6:8080";
        ...
        String ROOM_CATEGORY = APP_BASE_URL + "/roomCategory";
        ...
        String RESERVATION_CATEGORY = APP_BASE_URL + "/reservationCategory";
...
//        String ROOM_SERVICE = TEST_URL + "/aboutstays/roomService";
        ...
        String GET_ROOM_CATEGORIES_BY_HOTEL_ID = ROOM_CATEGORY + "/getByHotelId";
        ...
        String GET_RESERVATION_SUB_ITEMS = RESERVATION_ITEM + "/getAllByHotelId";
        ...
        String GET_LATE_CHECKOUT_INFO = ROOM_CATEGORY + "/getLateCheckoutInfo";
...
//        String GET_FEEDBACK_AND_SUGGESTIONS = STAYS_FEEDBACK + "/getAllByUserIdAndHotelId";
        ...
        String GET_EARLY_CHECKIN_INFO = ROOM_CATEGORY + "/getCheckinInfo";
        ...
        String GET_RESERVATION_CATEGORY = RESERVATION_CATEGORY + "/getAll";
    }
    interface PREF_KEYS {
    ...
    public static interface BUNDLE_KEYS {
        ...
        String RESERVATION_TYPE_CODE = "reservationTypeCode";
    ...
    interface APPLYPRESENT{
        String APPLYPRESENT = "Apply Present";
        int APPLYPRESENT_ID = 2;
    }

    interface APPLYEXPENSE{
        String APPLYEXPENSE = "Apply Expense";
        int APPLYEXPENSE_ID = 3;
    }

    interface BOOKSALES{
        String BOOKSALES = "Book Sales";
        int BOOKSALES_ID = 4;
    }

    interface ASSINGTASKS{
        String ASSINGTASKS = "Assign Task";
        int ASSINGTASKS_ID = 5;
    }

    interface GIVEASTAR{
        String GIVEASTAR = "Give a Star";
        int GIVEASTAR_ID = 6;
    }
